...
<body data-bs-spy="scroll" data-bs-target="#navbar" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true"
                    ...
                    <div class="offcanvas-body align-items-center">
                        <ul class="navbar-nav ms-5 flex-grow-1 pe-3">
                            <li class="nav-item ms-3">
                                <a class="nav-link text-dark active" aria-current="page" href="?page=index">Home</a>
                            </li>
                            <li class="nav-item ms-3">
                                <a class="nav-link text-dark" href="?page=about">About</a>
                            </li>
                            <li class="nav-item ms-3 ">
                                <a class="nav-link text-dark" href="?page=shop"> Shop</a>
                            </li>
                            <li class="nav-item ms-3 ">
                                <a class="nav-link text-dark" href="?page=gallery">Gallery</a>
                            </li>
                        </ul>
                            ...
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="image-holder mb-lg-0 mb-md-2">
                                        <img src="images/bannernw.jpg" alt="product"
                                ...
                                <div class="col-lg-5 col-md-11 col-sm-10 mx-auto">
                                    <div
                                        ...
                                        <div class="col-lg-9 col-md-6 col-sm-8 text-center mx-auto py-lg-6">
                                            <h1 class="display-3">Custom Aksesoris<span
                                                    class="display-6 text-secondary d-block">Kami bantu buatkan
                                                    aksesoris sesuai dengan requestmu</span>
                                            </h1>
                    ...
                    <div class="swiper-slide">
                        <div class="banner-item d-flex text-center align-items-center">
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="image-holder mb-lg-0 mb-md-2">
                                        <img src="images/banner-2.jpg" alt="product" class="img-fluid rounded-4">
                                    </div>
                                </div>
                                <div class="col-lg-5 col-md-11 col-sm-10 mx-auto">
                                    <div
                                        class="banner-content w-100 h-100 position-relative bg-light border rounded-4 mx-auto d-flex align-items-center">
                                        <div class="col-lg-9 col-md-6 col-sm-8 text-center mx-auto py-lg-6">
                                            <h1 class="display-2">Gelang Cantik<span
                                                    class="display-6 text-secondary d-block"></span>
                                            </h1>
                                            <div class="btn-center mt-4">
                    ...
                    <div class="swiper-slide">
                        <div class="banner-item d-flex text-center align-items-center">
                            <div class="row">
                                <div class="col-lg-7">
                                    <div class="image-holder mb-lg-0 mb-md-2">
                                        <img src="images/banner-image3.jpg" alt="product" class="img-fluid rounded-4">
                                    </div>
                                </div>
                                <div class="col-lg-5 col-md-11 col-sm-10 mx-auto">
                                    <div
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 mb-4">
                    <div class="image-holder position-relative">
                        <img src="images/cate-item1.jpg" alt="dress" class="img-fluid rounded-4">
                        <div class="btn-wrap position-absolute d-flex align-items-center justify-content-center">
                            <a href="shop-with-sidebar.html"
                                class="btn btn-md btn-light text-uppercase rounded-0">Dresses</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 mb-4">
                    <div class="image-holder position-relative">
                        <img src="images/cate-item2.jpg" alt="hats" class="img-fluid rounded-4">
                        <div class="btn-wrap position-absolute d-flex align-items-center justify-content-center">
                            <a href="shop-with-sidebar.html" class="btn btn-md btn-light text-uppercase rounded-0">Funny
                                Hats</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 mb-4">
                    <div class="image-holder position-relative">
                        <img src="images/cate-item3.jpg" alt="toys" class="img-fluid rounded-4">
                        <div class="btn-wrap position-absolute d-flex align-items-center justify-content-center">
                            <a href="shop-with-sidebar.html" class="btn btn-md btn-light text-uppercase rounded-0">Cute
                                Toys</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 mb-4">
                    <div class="image-holder position-relative">
                        <img src="images/cate-item4.jpg" alt="toys" class="img-fluid rounded-4">
                        <div class="btn-wrap position-absolute d-flex align-items-center justify-content-center">
                            <a href="shop-with-sidebar.html" class="btn btn-md btn-light text-uppercase rounded-0">Soft
                                Toys</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="swiper product-swiper">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="product-item">
                            <div class="image-holder text-center p-3 mb-4 border rounded-4">
                                <img src="images/product-item1.png" alt="toy" class="img-fluid">
                            </div>
                            <div class="product-info ps-2">
                                <h3 class="m-0">
    ...
    <section id="collection"
        style="background-image: url(images/bg-pattern.png); background-repeat: no-repeat; background-position: center; width: 100%; height: 810px;"
                ...
                <div class="col-lg-6 col-md-10 text-center">
                    <div class="text-content">
                        <div class="display-header">
                            <h2>Cute Toys Collections</h2>
                            <p class="mx-auto">Looking for a soft toy that will bring joy and comfort to both kids and
                                adults? Look no further than our collection of toys is great.</p>
                        </div>
                        <a href="shop-with-sidebar.html" class="btn btn-primary btn-md text-uppercase mt-4">Shop Now</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer id="footer" class="position-relative bg-light py-lg-7 my-lg-7 mb-lg-0">
        ...
        <div class="container">
            <div class="row d-flex flex-wrap justify-content-between">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-menu">
                        <h5 class="widget-title text-secondary">Help</h5>
                        <ul class="menu-list list-unstyled">
                            <li class="menu-item pb-2">
                                <a href="faqs.html" class="item-anchor">Faqs</a>
                            </li>
                            <li class="menu-item pb-2">
                                <a href="#" class="item-anchor">Privacy</a>
                            </li>
                            <li class="menu-item pb-2">
                                <a href="#" class="item-anchor">Terms</a>
                            </li>
                            <li class="menu-item pb-2">
                                <a href="#" class="item-anchor">Affiliate</a>
                            </li>
                            <li class="menu-item pb-2">
                                <a href="#" class="item-anchor">Get in touch</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-8 col-md-6 mb-3">
                    <div class="d-flex flex-wrap align-items-center">
                        <img src="images/main-logo.png" alt="brand name" class="pe-5">
                        <p class="m-0">©2024 Kara Handycrafts</p>
                    </div>
                </div>
                <!-- <div class="col-lg-4 col-md-6 text-center mb-3">
                    <p>Template designed by <a href="https://templatesjungle.com" target="_blank"
                            class="text-primary fw-bold">TemplatesJungle</a>
                </div> -->
            </div>
        </div>
    </div>
